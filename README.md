...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadAutolevelWidget</td><td>function</td><td>function (callback) <br><br>Load the Template widget via chilipeppr.load() so folks have a sample
