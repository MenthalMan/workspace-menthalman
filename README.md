# com-chilipeppr-workspace-menthalman
My Chilipeppr Workspace.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / menthalman
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-menthalman |
| Name                  | Workspace / menthalman |
| Description           | My Chilipeppr Workspace. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/MenthalMan/workspace-menthalman/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/menthalman/workspace-menthalman |
| Github URL            | http://github.com/MenthalMan/workspace-menthalman |
| Test URL              | https://preview.c9users.io/menthalman/workspace-menthalman/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/MenthalMan/workspace-menthalman/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-menthalman"], // the id you gave your workspace
      function(myWorkspaceMenthalman) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / menthalman just got loaded.", myWorkspaceMenthalman);
        myWorkspaceMenthalman.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-menthalman"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / menthalman"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"My Chilipeppr Workspace."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/MenthalMan/workspace-menthalman/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/menthalman/workspace-menthalman"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/MenthalMan/workspace-menthalman"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-menthalman-menthalman.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadAutolevelWidget</td><td>function</td><td>function (callback) <br><br>Load autolevel widget chilipeppr.load() so folks have a sample
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>load3dViewWidget</td><td>function</td><td>function (callback) <br><br>Load autolevel widget chilipeppr.load() so folks have a sample
